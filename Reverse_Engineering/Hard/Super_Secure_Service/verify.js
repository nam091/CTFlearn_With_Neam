...
function check2()
{
  ...
  function hash(_0x7a95x2){
    ...
    return Array[source[3]][source[2]][source[1]](_0x7a95x2,function(a,b){return (a* 31+ b[source[0]](0))& _0x7a95x3},0)
  }
  function xor(_0x7a95x7,_0x7a95x8){
    var z=source[4];
    for(var i=0;i< _0x7a95x7[source[5]];i++){
    ...
    var z=source[4];
    for(var i=0;i< _0x7a95x7[source[5]];i++){
      z+= String[source[6]](_0x7a95x7[source[0]](i)^ (_0x7a95x8[source[0]](i% _0x7a95x8[source[5]])& 15))
    };
    return z
  }
  function decode(_0x7a95xd,_0x7a95xe,_0x7a95xf){
    ...
    function runcode(_0x7a95x11,_0x7a95xd,_0x7a95xe){
      ...
      try{
        ...
        var _0x7a95xf=0;
        for(var i=0;i< _0x7a95xe[source[5]]* 2;i++){ 
          new Function(source[7],_0x7a95x12[source[8]])(_0x7a95x12)};
          return _0x7a95x12[source[7]]
        }catch(e){
          throw source[9]}
      }
      seed(18458);
      j++;
      input= $(source[11])[source[10]];
      ...
      d= (random()+ random())& b;
      if(!input[source[14]](source[13])|| input[source[15]](-FALSE) != source[16] || hash(input)!=  -1996285287 || input[source[5]]!= (random()& c)){
        throw source[9]
      };
      f= random()& b- d;
      ...
      if(input[source[5]]!= f|| input[+FALSE][source[5]]!= f- FALSE- TRUE|| input[+FALSE][+FALSE] != 'R'){throw source[9]};
      try{
        ...
        if(input[FALSE+ FALSE- TRUE][source[5]]!= c- d){
          throw source[9]
        };
        if(input[d]!= runcode($(source[22])[source[10]],xor($(source[23])[source[10]],c- d),input[FALSE+ FALSE])){throw source[9]}
}
